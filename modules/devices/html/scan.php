<div class="alert alert-warning" role="alert">Sensors I2C, 1wire gpio, some 1wire USB, 1wire OWFS and lmsensors are detected automatically go to <a href="index.php?id=devices&type=sensors" class="btn btn-xs btn-warning">Devices</a></div>
