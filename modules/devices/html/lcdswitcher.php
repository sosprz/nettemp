...
?>
<p>
<a href="index.php?id=devices&type=lcd&lcd=groups" ><button class="btn btn-xs btn-default <?php echo $lcd == 'groups' ? 'active' : ''; ?>">Groups</button></a>
<a href="index.php?id=devices&type=lcd&lcd=settings" ><button class="btn btn-xs btn-default <?php echo $lcd == 'settings' ? 'active' : ''; ?>">LCD Configuration</button></a>
</p>
