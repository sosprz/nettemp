...
<td>
	...
	<input type="checkbox" data-toggle="toggle" data-size="mini"  name="upsbacklight" value="NO" data-on="TAK" data-off="NO" <?php echo $nts_ups_lcd_backlight == 'TAK' ? 'checked="checked"' : ''; ?> />
