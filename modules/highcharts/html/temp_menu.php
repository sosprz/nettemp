...
<table><tr>
<td><a href="index.php?id=view&type=temp&highcharts=hour" ><button>hour</button></a></td>
<td><a href="index.php?id=view&type=temp&highcharts=day" ><button>day</button></a></td>
<td><a href="index.php?id=view&type=temp&highcharts=week" ><button>week</button></a></td>
<td><a href="index.php?id=view&type=temp&highcharts=month" ><button>month</button></a></td>
<td><a href="index.php?id=view&type=temp&highcharts=year" ><button>year</button></a></td>
</tr>
</table>
