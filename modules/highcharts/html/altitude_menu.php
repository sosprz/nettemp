...
<table><tr>
<td><a href="index.php?id=view&type=altitude&highcharts=hour" ><button>hour</button></a></td>
<td><a href="index.php?id=view&type=altitude&highcharts=day" ><button>day</button></a></td>
<td><a href="index.php?id=view&type=altitude&highcharts=week" ><button>week</button></a></td>
<td><a href="index.php?id=view&type=altitude&highcharts=month" ><button>month</button></a></td>
<td><a href="index.php?id=view&type=altitude&highcharts=year" ><button>year</button></a></td>
</tr>
</table>
