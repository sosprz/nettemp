...
<table><tr>
<td><a href="index.php?id=view&type=humi&highcharts=hour" ><button>hour</button></a></td>
<td><a href="index.php?id=view&type=humi&highcharts=day" ><button>day</button></a></td>
<td><a href="index.php?id=view&type=humi&highcharts=week" ><button>week</button></a></td>
<td><a href="index.php?id=view&type=humi&highcharts=month" ><button>month</button></a></td>
<td><a href="index.php?id=view&type=humi&highcharts=year" ><button>year</button></a></td>
</tr>
</table>
