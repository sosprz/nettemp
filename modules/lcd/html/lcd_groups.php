...
?>
    ...
    $grpkeys = '';
    foreach($groups as $group){ ?>
	<a href="index.php?id=devices&type=lcd&lcd=groups&edit=<?php echo $group['grpkey'];?>" ><button class="btn btn-xs btn-success <?php echo $edit == $group['grpkey'] ? 'active' : ''; ?>"><?php echo $group['name'];?></button></a>
