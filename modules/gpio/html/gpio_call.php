...
<form action="" method="post" style=" display:inline!important;">
    <button type="submit" name="tel_any"  <?php echo $a['tel_any'] == 'on' ? 'class="btn btn-xs btn-danger" value="off"' : 'class="btn btn-xs btn-default" value="on"'; ?> onchange="this.form.submit()" >Any number</button>
