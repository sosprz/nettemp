...
?>    
<form action="" method="post" style=" display:inline!important;">
    <button type="submit" name="<?php echo $to; ?>"  <?php echo $b["$to"] == 'on' ? 'class="btn btn-xs btn-danger" value="off"' : 'class="btn btn-xs btn-info" value="on"'; ?> onchange="this.form.submit()" ><?php echo $b['name']; ?></button>
...
<form action="" method="post" style=" display:inline!important;">
    <button type="submit" name="con"  <?php echo $a['trigger_con'] == 'on' ? 'class="btn btn-xs btn-danger" value="off"' : 'class="btn btn-xs btn-info" value="on"'; ?> onchange="this.form.submit()" >Continous mode</button>
    <input type="hidden" name="gpio" value="<?php echo $a['gpio'] ?>" />
    <input type="hidden" name="cononoff" value="onoff" />
</form>

<form method="post" type="submit" style=" display:inline!important;">
    <button type="submit" name="triggernotice_checkbox"  <?php echo $a['trigger_notice'] == 'on' ? 'class="btn btn-xs btn-danger" value=""' : 'class="btn btn-xs btn-info" value="on"'; ?> onchange="this.form.submit()" >Send mail</button>
