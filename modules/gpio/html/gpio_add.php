...
if ( $add == "ADD") {
	...
	if (!empty($gpioad)) { 
	    $db->exec("INSERT INTO gpio (gpio, name, status, fnum, map_pos, map_num, map) VALUES ('$gpio','new_$gpio','OFF','1', '{left:0,top:0}', '$map_num', 'on' )") or exit(header("Location: html/errors/db_error.php"));
	}
	else {
