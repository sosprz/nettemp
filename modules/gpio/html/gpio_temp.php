...
<form action="" method="post" style=" display:inline!important;">
	    ...
	    <button type="submit" name="dayrun" value="<?php echo $a["day_run"] == 'on' ? 'off' : 'on'; ?>" <?php echo $a["day_run"] == 'on' ? 'class="btn btn-xs btn-danger"' : 'class="btn btn-xs btn-default"'; ?> >
...
<form action="" method="post" style=" display:inline!important;">
    ...
    <button type="submit" class="btn btn-xs btn-default"><span class="glyphicon glyphicon-play" aria-hidden="true"></span> Start</button>
</form>
<form action="" method="post" style=" display:inline!important;">
