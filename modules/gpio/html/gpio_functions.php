...
//humid
    ...
    if ($humidon == "humidon")  {
		...
		// insert to sensors
		$db->exec("INSERT OR IGNORE INTO sensors (position, name, rom, type, alarm, tmp, gpio, adj, charts, device, ch_group, position_group, logon, thing, readerr, readerralarm, ghide, hide) VALUES ('1','$randh','$id_rom_newh', 'humid', 'off', 'wait', '$gpio_post', '0', 'on', 'humid', '1', 'sensors', 'off', 'off', '60', 'off', 'off', 'off')") or die ("cannot insert to DB humi" );
		$db->exec("INSERT OR IGNORE INTO sensors (position, name, rom, type, alarm, tmp, gpio, adj, charts, device, ch_group, position_group, logon, thing, readerr, readerralarm, ghide, hide) VALUES ('1','$randt','$id_rom_newt', 'temp', 'off', 'wait', '$gpio_post', '0', 'on', 'temp', '1', 'sensors', 'off', 'off', '60', 'off', 'off', 'off')") or die ("cannot insert to DB temp" );
