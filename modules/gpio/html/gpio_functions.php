...
//humid
    ...
    if ($humidon == "humidon")  {
		...
		// insert to sensors
		$db->exec("INSERT OR IGNORE INTO sensors (name, rom, type, alarm, tmp, gpio, adj, charts, device, ch_group) VALUES ('$randh','$id_rom_newh', 'humid', 'off', 'wait', '$gpio_post', '0', 'on', 'gpio', 'sensors')") or die ("cannot insert to DB humi" );
