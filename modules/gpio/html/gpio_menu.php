...
<tr>
	...
	<td class="col-md-1">
		<a href="index.php?id=device&type=gpio&gpios=<?php echo $b['gpio']?>&ip=<?php echo $b['ip']?>&roms=<?php echo $b['rom']?>" class="btn btn-xs btn-success ">GPIO <?php echo $b['gpio']; if(!empty($b['ip'])){echo " ".$b["ip"];}?></a>
	</td>
