...
<div class="panel panel-info">
	...
	<div class="panel-body">
	    No SMS modem set
  <a href="index.php?id=devices&type=usb" class="btn btn-xs btn-info" role="button">Go to USB/Serial</a>
	</div>
</div>
<?php
} else {
...
<div class="panel panel-info"><div class="panel-heading">SMS modem <?php echo $smsdev." "?></div>
<div class="panel-body">
...
?>
    ...
    <button id="smsc1" name="smsc1"  value="smsc2" class="btn btn-xs btn-info">Save </button>
</form>
<br>
<form class="form-inline" action="" method="post">
    ...
    <button id="sms_test1" name="sms_test1" value="sms_test1" class="btn btn-xs btn-info">Send test </button>
</form>
...
<div class="panel panel-info">
	...
	<div class="panel-body">
	    No Call modem set <a href="index.php?id=devices&type=usb" class="btn btn-xs btn-info" role="button">Go to USB/Serial</a>
	</div>
</div>
<?php
} else {
...
<div class="panel panel-info"><div class="panel-heading">Call modem <?php echo $dev ?></div>
<div class="panel-body">
