...
?>
<p>
<a href="index.php?id=view&type=temp&max=hour" ><button class="btn btn-xs btn-default <?php echo $art == 'temp' ? ' active' : ''; ?>">Temperature</button></a>
<?php 
if (in_array('humid', $type))  {?>
<a href="index.php?id=view&type=humid&max=hour" ><button class="btn btn-xs btn-default <?php echo $art == 'humid' ? ' active' : ''; ?>">Humidity</button></a>
<?php }
if (in_array('press', $type))  {?>
<a href="index.php?id=view&type=press&max=hour" ><button class="btn btn-xs btn-default <?php echo $art == 'press' ? ' active' : ''; ?>">Pressure</button></a>
<?php }
if (in_array('altitude', $type))  {?>
<a href="index.php?id=view&type=altitude&max=hour" ><button class="btn btn-xs btn-default <?php echo $art == 'altitude' ? ' active' : ''; ?>">Altitude view</button></a>
<?php }
...
<a href="index.php?id=view&type=elec&max=hour" ><button class="btn btn-xs btn-default <?php echo $art == 'elec' ? ' active' : ''; ?>">Electricity</button></a>
<?php } 
if (in_array('water', $type))  {?>
<a href="index.php?id=view&type=water&max=hour" ><button class="btn btn-xs btn-default <?php echo $art == 'water' ? ' active' : ''; ?>">Water</button></a>
<?php } 
if (in_array('gas', $type))  {?>
<a href="index.php?id=view&type=gas&max=hour" ><button class="btn btn-xs btn-default <?php echo $art == 'gas' ? ' active' : ''; ?>">Gas</button></a>
<?php } 
if (in_array('lux', $type))  {?>
<a href="index.php?id=view&type=lux&max=hour" ><button class="btn btn-xs btn-default <?php echo $art == 'lux' ? ' active' : ''; ?>">Light</button></a>
<?php } 
if (in_array('volt', $type))  {?>
<a href="index.php?id=view&type=volt&max=hour" ><button class="btn btn-xs btn-default <?php echo $art == 'volt' ? ' active' : ''; ?>">Voltage</button></a>
<?php } 
if (in_array('amps', $type))  {?>
<a href="index.php?id=view&type=amps&max=hour" ><button class="btn btn-xs btn-default <?php echo $art == 'amps' ? ' active' : ''; ?>">Ampere</button></a>
<?php } 
if (in_array('watt', $type))  {?>
<a href="index.php?id=view&type=watt&max=hour" ><button class="btn btn-xs btn-default <?php echo $art == 'watt' ? ' active' : ''; ?>">Watt</button></a>
<?php } 
if (glob('db/gpio_stats_*')) {?>
<a href="index.php?id=view&type=gpio&max=hour" ><button class="btn btn-xs btn-default <?php echo $art == 'gpio' ? ' active' : ''; ?>">GPIO</button></a>
<?php } 
if ( $hostc >= "1")  {?>
<a href="index.php?id=view&type=hosts&max=hour" ><button class="btn btn-xs btn-default <?php echo $art == 'hosts' ? ' active' : ''; ?>">Hosts</button></a>
<?php } 
if (in_array('dist', $type))  {?>
<a href="index.php?id=view&type=dist&max=hour" ><button class="btn btn-xs btn-default <?php echo $art == 'dist' ? ' active' : ''; ?>">Distance</button></a>
<?php } 
?>
<a href="index.php?id=view&type=system&max=hour" ><button class="btn btn-xs btn-default <?php echo $art == 'system' ? ' active' : ''; ?>">System stats</button></a>
