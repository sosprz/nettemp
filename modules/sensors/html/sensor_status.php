...
if ($numRows == 0 ) { echo "<span class=\"empty\"><img src=\"media/ico/Sign-Stop-icon.png\" /></span>"; }
	...
	if($a[type] == lux){
		if($a[tmp] >= $a[tmp_max] && !empty($a[tmp]) && !empty($a[tmp_max]) && $a[alarm] == on ) { ?> <tr><td><img src="media/ico/sun-icon.png" /></td><td><font color="#FF0000"> <?php echo $a[name]; ?></td><td><font color="#FF0000"><?php echo "$a[tmp]lux"; echo " max: $a[tmp_max] lux"  ?></font></td></tr><?php	}
		elseif($a[tmp] <= $a[tmp_min] && !empty($a[tmp]) && !empty($a[tmp_min]) && $a[alarm] == on ) { ?> <tr><td><img src="media/ico/sun-icon.png" /></td><td><font color="#0095FF"> <?php echo $a[name]; ?></td><td><font color="#0095FF"><?php echo "$a[tmp]lux"; echo " min: $a[tmp_min] lux" ?></font></td></tr>  <?php	}
