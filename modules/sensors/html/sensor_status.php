...
if ($numRows == 0 ) { echo "<span class=\"empty\"><img src=\"media/ico/Sign-Stop-icon.png\" /></span>"; }
	...
	if($a['type'] == 'snmp'){
		...
		<tr>
		    <td></td>
		    <td><img src="media/ico/temp_low.png" /></td><td><font color="#0095FF"> <?php echo $name ?></td>
	...
	if($a['type'] == 'humid'){
		...
		<tr>
		    <td><?php if($a['device'] == 'wireless'){ ?><img src="media/ico/wifi-circle-icon.png" /><?php } ?></td>
		    <td><img src="media/ico/rain-icon.png" /></td><td><font color="#FF0000"> <?php echo $name ?></td>
		...
		<tr>
		    <td><?php if($a['device'] == 'wireless'){ ?><img src="media/ico/wifi-circle-icon.png" /><?php } ?></td>
		    <td><img src="media/ico/rain-icon.png" /></td><td><font color="#0095FF"> <?php echo $name ?></td>
