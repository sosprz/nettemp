...
$db->exec("INSERT OR IGNORE INTO html (name, state) VALUES ('info', 'off')");
$db->exec("INSERT OR IGNORE INTO html (name, state) VALUES ('footer', 'off')");
$db->exec("INSERT OR IGNORE INTO html (name, state) VALUES ('screen', 'on')");
$db->exec("INSERT OR IGNORE INTO html (name, value) VALUES ('nettemp_logo', ' media/png/logger3d.png')");
