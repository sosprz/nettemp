...
$db->exec("CREATE TABLE types (id INTEGER PRIMARY KEY,type UNIQUE, unit TEXT, ico TEXT, title TEXT)");
$db->exec("INSERT OR IGNORE INTO types (type, unit, ico, title) VALUES ('temp', 'C', 'media/ico/temp2-icon.png' ,'Temperature')");
