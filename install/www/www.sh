...
sed -i 's/upload_max_filesize = 2M/upload_max_filesize = 300M/g' /etc/php/7.3/cgi/php.ini
sed -i 's/post_max_size = 8M/post_max_size = 300M/g' /etc/php/7.3/cgi/php.ini
...
sed -i 's/upload_max_filesize = 2M/upload_max_filesize = 300M/g' /etc/php/7.3/fpm/php.ini
sed -i 's/post_max_size = 8M/post_max_size = 300M/g' /etc/php/7.3/fpm/php.ini
