...
<tr>
	...
	<td>
	    <small>
	    <a href="index.php?id=view&type=<?php echo $a['type']?>&max=day&single=<?php echo $a['name']?>" class="label label-info" title="kWh">
		<?php
		$rom=$a['rom'];
	...
	<td>
	    <small>
	    <a href="index.php?id=view&type=<?php echo $a['type']?>&max=week&single=<?php echo $a['name']?>" class="label label-info" title="kWh">
		<?php
	...
	<td>
	    <small>
	    <a href="index.php?id=view&type=<?php echo $a['type']?>&max=month&single=<?php echo $a['name']?>" class="label label-info" title="kWh">
		<?php
	...
	<td>
	    <small>
	    <a href="index.php?id=view&type=<?php echo $a['type']?>&max=day&single=<?php echo $a['name']?>" class="label label-danger" title="kWh">
		<?php
	...
	<td>
	    <small>
	    <a href="index.php?id=view&type=<?php echo $a['type']?>&max=day&single=<?php echo $a['name']?>&mode=2" class="label label-warning" title="W">
		<?php
